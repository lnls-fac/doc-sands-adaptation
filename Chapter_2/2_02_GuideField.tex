...
\end{align}
where the positive direction of $\theta_0$ (counter-clockwise) is opposite to that of the electron orbit and the angle swept out in one revolution must be $2\pi$; so $G(s)$ must satisfy
\begin{align}
